 ...
 * 1. Datos de entrada, a=2, b=10
 * 2. Bucle (while) con contador=a e incrementar 'b' veces
 *    (puede ser al reves) contador=b, incrementar 'a' veces
 * 3. Sumar el incremental
*/
#include <iostream>
...
int main(){
  ...
  */
  ...
  // 1. Guardar el numero mayor 'a' y 'b'
  // este el valor que se sumara
  // 2. Guardar el numero menor entre 'a' y 'b'
  // este sera la cantidad de iteraciones del oop
