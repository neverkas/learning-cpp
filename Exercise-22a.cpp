 ...
 *
 * 1. Bucle controlado por 'centinela' (centinela !=0)
 * > Seguirá iterando siempre que se cumpla esa condición
 * que centinela sea distinto de cero.
 * > Se detendrá cuando centinela sea igual a cero.
 * 1.2 Datos de entrada ('sueldo' = x)
 * > La variable debe ser float, para soportar decimales.
 * 1.2.1 Condicional (sueldo < 20000)
 * > Si se cumple la condición acumular en un contador 'A'
 * 1.2.2 Condicional (sueldo >= 2000 && sueldo < 3000)
 * > Si se cumple la condición acumular en un contador 'B'
 * 1.2.3 Condicional (sueldo >= 3000 && sueldo < 5000)
 * > Si se cumple la condición acumular en un contador 'C'
 * 1.2.4 Condicional (sueldo >= 5000)
 * > Si se cumple la condición acumular en un contador 'D'
 *
...
int main(){
  /*
  * 1. Defino las variables y les asigno valor
