...
Solución (Pseudocódigo)
	...
	VARIABLES
		ingresar_mpares
		color, numero,
	  contador_color_negro=0, 
		contador_colores_alternados = 0
		contador_segunda_docena = 0
		numeros[36]
		contador=0

	INICIO
		LEER(ingresar_mpares)
		numeros_anteriores_al_cero[ingresar_mpares];

		MIENTRAS(contador < ingresar_mpares)
			numero = aleatorio(numero)
			color = aleatorio(color)
			...
			SI(numero == 0)
				numeros_anteriores_al_cero[] = numero
			
			SI(numero > 12 && numero < 23)
...
int main(){
  ...
  int lista_numeros_repetidos_length;
	...
	cout << "Veces que se repite el cero: ";
	cout << lista_numeros_repetidos[0];
	cout << '\n'; // new line
	...
	cout << "Veces que se repite el color negro: ";
	cout << contador_color_negro;
	cout << '\n'; // new line

	cout << "Veces que se nego la segunda docena: ";
	cout << contador_segunda_docena;
	cout << '\n'; // new line
